...
config = Configuration('sotonjavelin',parent_package=None,top_path=None)
...
if lapack_info:
    config.add_extension(name='gp.linalg_utils',sources=['sotonjavelin/gp/linalg_utils.f','sotonjavelin/blas_wrap.f'], extra_info=lapack_info)
    config.add_extension(name='gp.incomplete_chol',sources=['sotonjavelin/gp/incomplete_chol.f'], extra_info=lapack_info)
...
if not lapack_info or dist in ['bdist', 'sdist']:
    ...
    f_sources = ['sotonjavelin/blas_wrap.f']
    ...
    config.add_extension(name='gp.linalg_utils',sources=['sotonjavelin/gp/linalg_utils.f'] + f_sources)
    config.add_extension(name='gp.incomplete_chol',sources=['sotonjavelin/gp/incomplete_chol.f'] + f_sources)


# Compile covariance functions
config.add_extension(name='gp.cov_funs.isotropic_cov_funs',\
sources=['sotonjavelin/gp/cov_funs/isotropic_cov_funs.f','blas/BLAS/dscal.f'],\
extra_info=lapack_info)

config.add_extension(name='gp.cov_funs.distances',sources=['sotonjavelin/gp/cov_funs/distances.f'], extra_info=lapack_info)

config.add_extension(name='spear_covfunc',sources=['sotonjavelin/spear_covfunc.f90'], extra_info=lapack_info)
